      ...
      <div className="mb-8">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-4">
            ...
            <div>
              <h1 className="text-3xl font-bold text-gray-900">Play Games</h1>
              <p className="text-gray-600">Challenge yourself with chess puzzles and cube solving</p>
            </div>
          </div>
        ...
        <div className="bg-white rounded-xl shadow-sm p-6">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p className="text-2xl font-bold text-gray-900">{userStats?.current_streak || 0}</p>
            </div>
          </div>
        </div>
      </div>
